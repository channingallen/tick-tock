...
export default Ember.Route.extend({
  ...
  beforeModel() {
    this.store.createRecord('entry', {date: 'Oct 28', id: 1, time: '3:00', project: 'Tick Tock', description: 'Initiated the Tick Tock application'});
    this.store.createRecord('entry', {date: 'Oct 21', id: 2, time: '1:00', project: 'Handle', description: 'Helped Courtland with the application'});
    this.store.createRecord('entry', {date: 'Oct 18', id: 3, time: '2:45', project: 'Tick Tock', description: 'Implemented time tracking functionality'});
    this.store.createRecord('entry', {date: 'Oct 06', id: 4, time: '4:30', project: 'The River Six', description: 'Made progress on the final chapter'});
